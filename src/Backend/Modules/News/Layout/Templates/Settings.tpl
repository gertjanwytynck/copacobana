...
<div class="pageTitle">
	<h2>{$lblModuleSettings|ucfirst}: {$lblNews}</h2>
</div>
...
{form:settings}
	<div class="box">
		...
		<div class="options">
			...
			<p>
				<label for="recentArticlesListNumItems">{$msgNumItemsInRecentArticlesList}</label>
				{$ddmRecentArticlesListNumItems} {$ddmRecentArticlesListNumItemsError}
			</p>
		</div>
	</div>
