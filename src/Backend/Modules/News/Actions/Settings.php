...
/**
 * This is the settings-action, it will display a form to set general news settings
 *
...
class Settings extends ActionEdit
{
    ...
    private function validateForm()
    {
        if ($this->frm->isSubmitted()) {
            ...
            $ddmRecentArticlesListNumitems = $this->frm->getField('recent_articles_list_num_items');
            ...
            if ($this->frm->isCorrect()) {
                ...
                Model::setModuleSetting($this->module, 'recent_articles_list_num_items', (int) $ddmRecentArticlesListNumitems->getValue());
