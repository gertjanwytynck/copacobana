...
<?php $includes = array();
                ...
                ob_start();
                ?>/Applications/MAMP/htdocs/copacobana/app/../src/Frontend/Themes/Copacobana/Core/Layout/Templates/Elements/FooterContent.tpl<?php
                $includes[] = str_replace('//', '/', eval('return \'' . str_replace('\'', '\\\'', ob_get_clean()) .'\';'));
                ob_start();
                ?>/Applications/MAMP/htdocs/copacobana/app/../src/Frontend/Core/Layout/Templates/Elements/FooterContent.tpl<?php
                $includes[] = str_replace('//', '/', eval('return \'' . str_replace('\'', '\\\'', ob_get_clean()) .'\';'));
                foreach($includes as $include) if(@file_exists($include) && is_file($include)) break;
                if($this->getForceCompile() || !file_exists($this->getCompileDirectory() .'/' . $this->getCompileName($include, '/Applications/MAMP/htdocs/copacobana/src/Frontend/Themes/Copacobana/Core/Layout/Templates/Partials'))) $this->compile('/Applications/MAMP/htdocs/copacobana/src/Frontend/Themes/Copacobana/Core/Layout/Templates/Partials', $include);
                $return = @include $this->getCompileDirectory() .'/' . $this->getCompileName($include, '/Applications/MAMP/htdocs/copacobana/src/Frontend/Themes/Copacobana/Core/Layout/Templates/Partials');
                if($return === false && $this->compile('/Applications/MAMP/htdocs/copacobana/src/Frontend/Themes/Copacobana/Core/Layout/Templates/Partials', $include)) {
                    $return = @include $this->getCompileDirectory() .'/' . $this->getCompileName($include, '/Applications/MAMP/htdocs/copacobana/src/Frontend/Themes/Copacobana/Core/Layout/Templates/Partials');
                }
if($return === false) {
...
<?php
						if(!isset($this->variables['jsFiles']))
						{
							...
							$this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']['fail'] = true;
						}
					$this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']['iteration'] = $this->variables['jsFiles'];
				if(isset(${'jsFiles'})) $this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']['old'] = ${'jsFiles'};
				$this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']['i'] = 1;
				$this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']['count'] = count($this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']['iteration']);
				foreach($this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']['iteration'] as ${'jsFiles'})
				{
					if(is_array(${'jsFiles'}))
					{
						if(!isset(${'jsFiles'}['first']) && $this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']['i'] == 1) ${'jsFiles'}['first'] = true;
						if(!isset(${'jsFiles'}['last']) && $this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']['i'] == $this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']['count']) ${'jsFiles'}['last'] = true;
...
<?php
					$this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']['i']++;
				}
					if(isset($this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']['fail']) && $this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']['fail'] == true)
					{
						?>{/iteration:jsFiles}<?php
					}
				if(isset($this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']['old'])) ${'jsFiles'} = $this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']['old'];
				else unset($this->iterations['723a14f1912e27ad50adae2393835831_Footer.tpl.php_1']);
				?>
...
<script src="<?php if(array_key_exists('THEME_URL', (array) $this->variables)) { echo $this->variables['THEME_URL']; } elseif(is_object($this->variables) && method_exists($this->variables, 'getTHEMEURL')) { echo $this->variables->getTHEMEURL(); } else { ?>{$THEME_URL}<?php } ?>/vendor/session/session.js"></script>
