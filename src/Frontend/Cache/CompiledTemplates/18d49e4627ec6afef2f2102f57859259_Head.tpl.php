  ...
  <link href='https://api.mapbox.com/mapbox-gl-js/v0.34.0/mapbox-gl.css' rel='stylesheet' />
	...
	<?php
						if(!isset($this->variables['cssFiles']))
						{
							...
							$this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']['fail'] = true;
						}
					$this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']['iteration'] = $this->variables['cssFiles'];
				if(isset(${'cssFiles'})) $this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']['old'] = ${'cssFiles'};
				$this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']['i'] = 1;
				$this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']['count'] = count($this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']['iteration']);
				foreach($this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']['iteration'] as ${'cssFiles'})
				{
					if(is_array(${'cssFiles'}))
					{
						if(!isset(${'cssFiles'}['first']) && $this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']['i'] == 1) ${'cssFiles'}['first'] = true;
						if(!isset(${'cssFiles'}['last']) && $this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']['i'] == $this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']['count']) ${'cssFiles'}['last'] = true;
	...
	<?php
					$this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']['i']++;
				}
					if(isset($this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']['fail']) && $this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']['fail'] == true)
					{
						?>{/iteration:cssFiles}<?php
					}
				if(isset($this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']['old'])) ${'cssFiles'} = $this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']['old'];
				else unset($this->iterations['18d49e4627ec6afef2f2102f57859259_Head.tpl.php_1']);
				?>
