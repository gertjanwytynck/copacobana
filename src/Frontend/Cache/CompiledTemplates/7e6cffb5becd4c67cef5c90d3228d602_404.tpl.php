            ...
            <div class="col-md-12 text-center">
                <?php
						if(!isset($this->variables['positionMain']))
						{
							...
							$this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']['fail'] = true;
						}
					$this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']['iteration'] = $this->variables['positionMain'];
				if(isset(${'positionMain'})) $this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']['old'] = ${'positionMain'};
				$this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']['i'] = 1;
				$this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']['count'] = count($this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']['iteration']);
				foreach($this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']['iteration'] as ${'positionMain'})
				{
					if(is_array(${'positionMain'}))
					{
						if(!isset(${'positionMain'}['first']) && $this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']['i'] == 1) ${'positionMain'}['first'] = true;
						if(!isset(${'positionMain'}['last']) && $this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']['i'] == $this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']['count']) ${'positionMain'}['last'] = true;
                ...
                <?php
					$this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']['i']++;
				}
					if(isset($this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']['fail']) && $this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']['fail'] == true)
					{
						?>{/iteration:positionMain}<?php
					}
				if(isset($this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']['old'])) ${'positionMain'} = $this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']['old'];
				else unset($this->iterations['7e6cffb5becd4c67cef5c90d3228d602_404.tpl.php_1']);
				?>
            </div>
        </div>
    </section>
...
<footer>
    <a href="/"><img src="<?php if(array_key_exists('THEME_URL', (array) $this->variables)) { echo $this->variables['THEME_URL']; } elseif(is_object($this->variables) && method_exists($this->variables, 'getTHEMEURL')) { echo $this->variables->getTHEMEURL(); } else { ?>{$THEME_URL}<?php } ?>/Core/Layout/images/copacobana.png" title="copacobana" alt="copacobana" class="copa-footer" /></a>
    <?php $includes = array();
                ob_start();
