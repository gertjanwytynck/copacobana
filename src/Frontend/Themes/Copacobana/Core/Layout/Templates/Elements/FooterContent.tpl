            ...
            <div class="row">
                <div class="col-md-12">
                    <ul>
                        ...
                        <!-- <li><a href="https://docs.google.com/forms/d/1FzA-sEjGNXUUJ35k5qabYRFbvOobKpwjTJoc0LjYPHU/viewform" target="_blank">{$lblBecomeVolunteer|ucfirst}</a></li> -->
    ...
    <section class="sponsors box-shadow">
        <div class="container-fluid">
            <ul>
                ...
                <li class="mob"><a href="http://depannage-lybaert.be/" target="_blank"><img src="{$THEME_URL}/Core/Layout/images/lybaert.png" title="Lybaert" alt="Lybaert" /></a></li>
                <li class="mob"><a href="http://www.oost-vlaanderen.be/public/index.cfm" target="_blank"><img src="{$THEME_URL}/Core/Layout/images/oost-vlaanderen.png" title="Oost-Vlaanderen" alt="Oost-Vlaanderen" /></a></li>
                <li class="mob"><a href="http://www.verbauwhede.com/" target="_blank"><img src="{$THEME_URL}/Core/Layout/images/verbauwhede.png" title="Verbauwhede" alt="Verbauwhede" /></a></li>
            </ul>
        </div>
    </section>
</footer>
